# termux-ath9k-vm — Lite v0.3.2

A lightweight Alpine Linux ARM64 VM companion for Android/Termux and QEMU TCG without KVM. Lite v0.3.2 is an additive corrected image; the canonical Full v0.3.0 release remains unchanged and is shipped beside it in the unified archive.
...
See `docs/LITE-v0.3.2.md` for the correction details and reproducible rebuild command.
